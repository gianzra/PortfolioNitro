    ...
    >
      ...
      >
        ...
        <Flex
          ...
          rowGap={{ base: 3, lg: 5 }}
        >
          <SectionSubtitle>All Certificate I&apos;ve 💼</SectionSubtitle>
          <SectionDescription>I have acquired various certificates across different fields to continuously enhance my knowledge and skills, demonstrating my commitment to lifelong learning and professional development.</SectionDescription>
        </Flex>
